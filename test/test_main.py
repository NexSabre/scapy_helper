...
class TestScapyHelper(TestCase):
    def setUp(self):
        ...
        self.ether2 = Ether(dst="00:00:00:00:00:00", src="00:00:00:00:00:00")
    ...
    def test_get_diff_should_be_the_same_as_diff(self):
        ...
        self.assertEqual(
            fun_diff, fun_get_diff, "The result of get_diff and diff should be the same"
        )
    ...
    def test_show_diff(self):
        ...
        self.assertEqual(first_row, "__ __ __ __ __ __ __ __ __ __ 00 __ __ __".split())
        self.assertEqual(
            second_row, "__ __ __ __ __ __ __ __ __ __ aa __ __ __".split()
        )
    ...
    def test_show_diff_for_same_elements(self):
        ...
        self.assertEqual(first_row, "__ __ __ __ __ __ __ __ __ __ __ __ __ __".split())
        self.assertEqual(
            second_row, "__ __ __ __ __ __ __ __ __ __ __ __ __ __".split()
        )
    ...
    def test_diff_should_return_same_len_list_if_one_of_them_was_shorter(self):
        ...
        diff_tuple = diff(self.ether, too_long_ether)
        self.assertEqual(
            len(diff_tuple[0]), len(diff_tuple[1]), "List should be the same length"
        )

        self.assertNotEqual(len(get_hex(self.ether).split()), len(diff_tuple[0]))
        self.assertEqual(len(too_long_ether.split()), len(diff_tuple[1]))

    def test_hex_equal(self):
        self.assertTrue(
            hex_equal(self.ether, "ff ff ff ff ff ff 00 00 00 00 00 00 90 00")
        )
    ...
    def test__prepare_encoded(self):
        obj = "\x00\x01".encode()
        self.assertEqual(
            _prepare(obj), ["00", "01"], "Object method hex, should return str of hex"
        )
