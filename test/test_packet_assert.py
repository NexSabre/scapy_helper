...
class TestPacketAssert(TestCase, PacketAssert):
    ...
    def test_assert_hex_equal_w_automatic_conversion(self):
        ...
        self.assertHexEqual(
            Ether(dst="ff:ff:ff:ff:ff:ff", src="00:00:00:00:00:00"), obj
        )

    def test_assert_hex_not_equal(self):
        self.assertHexNotEqual(
            Ether(dst="ff:ff:ff:ff:ff:ff", src="00:00:00:00:00:00"),
    ...
    def test_negative_assert_hex_different_at_position_hex_not_equal_list_is_subset(
        self,
    ):
        with self.assertRaises(AssertionError):
            self.assertHexDifferentAt(
